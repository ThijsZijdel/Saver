...
export class InMemoryDataService implements InMemoryDbService {
  createDb() {
    ...
    const spendings = [
      { id: 1, name: 'Salary', amount: 230.20, repeatingFk: null, description: 'desc.', date: new Date(), monthName: "Jun", monthFk: 1, subcategoryFk: 1, balanceFk: 1},
      { id: 2, name: 'Salary', amount: 100.40, repeatingFk: null, description: 'desc.', date: new Date(), monthName: "Jun", monthFk: 1, subcategoryFk: 2, balanceFk: 1  },
      { id: 3, name: 'Salary', amount: 700.10, repeatingFk: null, description: 'desc.', date: new Date(), monthName: "Jun", monthFk: 1, subcategoryFk: 3, balanceFk: 1  },
      { id: 4, name: 'Salary', amount: 50.30,  repeatingFk: null, description: 'desc.', date: new Date(), monthName: "Jun", monthFk: 1, subcategoryFk: 4, balanceFk: 1  },
      { id: 5, name: 'Salary', amount: 350.20, repeatingFk: null, description: 'desc.', date: new Date(), monthName: "Jun", monthFk: 1, subcategoryFk: 5, balanceFk: 1  },
      { id: 6, name: 'Salary', amount: 100,    repeatingFk: null, description: 'desc.', date: new Date(), monthName: "Jun", monthFk: 1, subcategoryFk: 6, balanceFk: 1  },
      { id: 7, name: 'Salary', amount: 200.40, repeatingFk: null, description: 'desc.', date: new Date(), monthName: "Jun", monthFk: 1, subcategoryFk: 7, balanceFk: 1  },
      { id: 8, name: 'Salary', amount: 700,    repeatingFk: null, description: 'desc.', date: new Date(), monthName: "Jun", monthFk: 1, subcategoryFk: 8, balanceFk: 1  },
      { id: 9, name: 'Salary', amount: 300.50, repeatingFk: null, description: 'desc.', date: new Date(), monthName: "Jun", monthFk: 1, subcategoryFk: 9, balanceFk: 1  },
      { id: 10, name: 'Salary', amount: 500.50,repeatingFk: null, description: 'desc.', date: new Date(), monthName: "Jun", monthFk: 1, subcategoryFk: 10, balanceFk: 1  },
      { id: 11, name: 'Salary', amount: 650.50,repeatingFk: null, description: 'desc.', date: new Date(), monthName: "Jun", monthFk: 1, subcategoryFk: 11, balanceFk: 1  },
      { id: 12, name: 'Salary', amount: 800,   repeatingFk: null, description: 'desc.', date: new Date(), monthName: "Jun", monthFk: 1, subcategoryFk: 12, balanceFk: 1  }
    ];
    const expenses = [
      ...
      { id: 2, name: 'Salary', amount: 300.40, repeatingFk: null, description: 'desc.', date: new Date(), monthName: "Feb", monthFk: 2, subCategoryFk: 8, balanceFk: 1, companyFk: 1, alreadyPaid: 1  },
